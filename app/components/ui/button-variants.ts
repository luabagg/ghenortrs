...
export const buttonVariants = cva(
  'inline-flex min-h-12 items-center justify-center gap-2 rounded-button border text-sm font-bold uppercase tracking-[0.08em] transition-colors active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background enabled:cursor-pointer disabled:cursor-not-allowed disabled:pointer-events-auto disabled:opacity-50',
  {
    variants: {
      variant: {
        primary:
